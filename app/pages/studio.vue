<template>
  <div>
    <MobileStudio v-if="isMobile" />
    <DesktopStudio v-else />
  </div>
</template>

<script setup>
import { useDevice } from '#imports'
import DesktopStudio from '~/components/desktop/DesktopStudio.vue'
import MobileStudio from '~/components/mobile/MobileStudio.vue'
